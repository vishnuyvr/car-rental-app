      ...
      <Row>
        <Col lg='8' md='8'>
          <div className="blog__details">
            ...
            <h2 className="section__title mt-3">{blog.title}</h2>
          ...
          <div className="comment__list mt-5">
            ...
            <div className="comment__content">
              ...
              <p className="section__description">Lorem ipsum dolor sit amet 
                consectetur adipisicing elit. Aut non nobis aliquid ipsa? Sequi, 
                accusamus.
              </p>
          ...
          blogData.map(item=>(
            <div className="recent__blog-post mb-4" key={item.id}>
              <div className="recent__blog-item d-flex gap-3">
                ...
                <h6 ><Link to={`/blog/${item.title}`} className='recent-heading'>
                {item.title}</Link></h6>
              </div>
            </div>
          ))

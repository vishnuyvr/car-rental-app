                    ...
                    <Col lg="5" md="5">
                      <div className="contact__info">
                        ...
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <p className="section__description mb-0">Fullerton, CA 92831</p>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className='fs-6 mb-0'>Phone: </h6>
                            <p className="section__description mb-0">+1(657)248-1234</p>
                        </div>

                        <div className="d-flex align-items-center gap-2">
                            <h6 className='mb-0 fs-6'>E-Mail: </h6>
                            <p className="section__description mb-0">vishnu@gmail.com</p>
                        </div>
